local shiftView = {}
shiftView.bg_gray = "assets/img/shift_gray.png"
shiftView.bg_bloom = "assets/img/shift_slot.png"
shiftView.images={"assets/img/S.png","assets/img/H.png","assets/img/I.png","assets/img/F.png","assets/img/T.png"}
